...
TEST_CASE("緑一色")
{
    ...
    BENCHMARK("緑一色")
    {
        auto &[hand, winning_tile, expected] = cases.front();
...
TEST_CASE("九蓮宝燈")
{
    ...
    {
        for (auto &[hand, winning_tile, expected] : cases) {
            bool actual = score.check_tyurenpoto(hand, winning_tile);
            INFO(fmt::format("手牌: {}, 和了牌: {}", hand.to_string(),
                             Tile::Names.at(winning_tile)));
            REQUIRE(actual == expected);
        }
    ...
    {
        auto &[hand, winning_tile, expected] = cases.front();
        score.check_tyurenpoto(hand, winning_tile);
    };
}
...
TEST_CASE("四暗刻単騎")
{
    ...
    {
        for (auto &[hand, winning_tile, expected] : cases) {
            bool actual = score.check_suanko_tanki(hand, winning_tile);
            INFO(fmt::format("手牌: {}, 和了牌: {}", hand.to_string(),
                             Tile::Names.at(winning_tile)));
            REQUIRE(actual == expected);
        }
    ...
    {
        auto &[hand, winning_tile, expected] = cases.front();
        score.check_suanko_tanki(hand, winning_tile);
    };
}
...
TEST_CASE("純正九蓮宝燈")
{
    ...
    {
        for (auto &[hand, winning_tile, expected] : cases) {
            bool actual = score.check_tyurenpoto9(hand, winning_tile);
            INFO(fmt::format("手牌: {}, 和了牌: {}", hand.to_string(),
                             Tile::Names.at(winning_tile)));
            REQUIRE(actual == expected);
        }
...
TEST_CASE("国士無双13面待ち")
{
    ...
    {
        for (auto &[hand, winning_tile, expected] : cases) {
            bool actual = score.check_kokusi13(hand, winning_tile);
            INFO(fmt::format("手牌: {}, 和了牌: {}", hand.to_string(),
                             Tile::Names.at(winning_tile)));
            REQUIRE(actual == expected);
        }
    ...
    {
        auto &[hand, winning_tile, expected] = cases.front();
        score.check_kokusi13(hand, winning_tile);
    };
}
