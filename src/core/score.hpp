...
public:
    ...
    Result calc(const Hand &tehai, int agarihai, YakuList yaku_list = Yaku::Null);
...
public:
    bool check_arguments(const Hand &tehai, int agarihai, YakuList yaku_list,
                         std::string &err_msg) const;
    YakuList check_yakuman(const Hand &tehai, int agarihai, YakuList flag,
                           int syanten_type) const;
    YakuList check_not_pattern_yaku(const Hand &tehai, int agarihai, YakuList flag,
                                    int syanten_type) const;
    std::tuple<YakuList, int, std::vector<Block>>
    check_pattern_yaku(const Hand &tehai, int agarihai, YakuList flag);
    int calc_hu(const std::vector<Block> &blocks, int agarihai, bool menzen, bool tumo,
                bool pinhu) const;
    ...
    Result aggregate(const Hand &tehai, int agarihai, YakuList yaku_list, bool tumo);
    Result aggregate(const Hand &tehai, int agarihai, YakuList yaku_list,
    ...
    create_block_patterns(const Hand &tehai, int agarihai, bool tumo) const;
    static std::vector<Block> get_blocks(const std::string &s);
    void create_block_patterns(const Hand &tehai, int agarihai, bool tumo,
    ...
    calc_hu(const std::vector<Block> &blocks, int agarihai, bool menzen,
            bool tumo) const;
    ...
    bool check_tyurenpoto(const Hand &tehai, int agarihai) const;
    ...
    bool check_suanko_tanki(const Hand &tehai, int agarihai) const;
    bool check_daisusi(const Hand &tehai) const;
    bool check_tyurenpoto9(const Hand &tehai, int agarihai) const;
    bool check_kokusi13(const Hand &tehai, int agarihai) const;
    // 一般役をチェックする関数
    ...
    bool check_pinhu(const std::vector<Block> blocks, int agarihai) const;
