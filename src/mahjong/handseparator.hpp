...
class HandSeparator
{
  public:
    ...
    static std::vector<std::tuple<std::vector<Block>, int>> separate(const Hand &hand, int win_tile,
                                                                     bool tumo);
  ...
  private:
    ...
    static void create_block_patterns(const Hand &hand, int win_tile, bool tumo,
