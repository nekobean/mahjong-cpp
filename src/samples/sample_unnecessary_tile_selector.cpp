...
int main(int, char **)
{
    // 一般手の不要牌を計算する
    {
        ...
        std::cout << fmt::format("[一般手の不要牌] 手牌: {}", hand.to_string()) << std::endl;
    ...
    // 七対子手の不要牌を計算する
    {
        ...
        std::cout << fmt::format("[七対子手の不要牌] 手牌: {}", hand.to_string()) << std::endl;
    ...
    // 国士無双手の不要牌を計算する
    {
        ...
        std::cout << fmt::format("[国士手の不要牌] 手牌: {}", hand.to_string()) << std::endl;
